...
{!! Form::model($receive2,['route' => ['forwardstore',$receive2->id], 'method' => 'post'] ) !!}
<input id="getx" name="getx" type="hidden" value="" />
<input id="gety" name="gety" type="hidden" value="" />

<img src="http://203.113.14.20:3000/output/{{$receive2->signature}}" style="border-style:groove;" onclick='clickHotspotImage(event)' />
