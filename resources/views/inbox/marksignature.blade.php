...
{!! Form::model($data,['route' => ['marksignaturestore',$data->id], 'method' => 'post'] ) !!}
<input id="getx" name="getx" type="hidden" value="" />
<input id="gety" name="gety" type="hidden" value="" />

<img src="http://203.113.14.20:3000/output/{{$data->signature}}" style="border-style:groove;"
    onclick='clickHotspotImage(event)' />

<button style="position: absolute; top: 20px; right: 180px;" type="submit"
    class="btn btn-outline-primary">Submit</button>
<button style="position: absolute; top: 20px; right: 100px;" type="reset" class="btn btn-outline-danger"
