...
{!! Form::model($receive,['route' => ['receivermarksignaturestore',$receive->id], 'method' => 'post'] ) !!}
<input id="getx" name="getx" type="hidden" value="" />
<input id="gety" name="gety" type="hidden" value="" />

<img src="http://203.113.14.20:3000/output/{{$data2->signature}}" style="border-style:groove;" onclick='clickHotspotImage(event)' />
