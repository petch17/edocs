...
{!! Form::model($receiver2,['route' => ['forwardstore',$receiver2->id], 'method' => 'post'] ) !!}
<input id="getx" name="getx" type="hidden" value="" />
<input id="gety" name="gety" type="hidden" value="" />

<img src="http://203.113.14.20:3000/send/{{$receiver2->id}}/merge.png" style="border-style:groove;" onclick='clickHotspotImage(event)' />
...
<script>
    ...
    function clickHotspotImage(event) {
        ...
        function photoclick(x,y){
            ...
            c1.src = "http://203.113.14.20:3000/imagesend/{{$receiver2->path}}";
